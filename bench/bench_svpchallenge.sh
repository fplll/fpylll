python -u bench_svpchallenge.py 44 32 > core02.log &
...
python -u bench_svpchallenge.py 64 32 > core12.log &
python -u bench_svpchallenge.py 76 32 > core13.log &
python -u bench_svpchallenge.py 78 32 > core14.log &
python -u bench_svpchallenge.py 80 32 > core15.log &

python -u bench_svpchallenge.py 44 32 > core22.log &
...
python -u bench_svpchallenge.py 64 32 > core22.log &
python -u bench_svpchallenge.py 76 32 > core23.log &
python -u bench_svpchallenge.py 78 32 > core24.log &
python -u bench_svpchallenge.py 80 32 > core15.log &
